...
# ----------------------------------
author: str = "Frank Scarpa"  
organization: str = "Frankly Figures"  
motto: str = "Making Numbers Talk" 
location: str = "Phoenix, Arizona"
...
office_locations: list[str] = ["Phoenix", "Washington DC", "Sunrise", "Austin", "San Francisco"]
